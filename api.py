...
def handle_dialog(req, res):
    ...
    if req['session']['new']:
        res['response'][
            'text'] = 'Здравствуйте, я могу посоветовать вам много различных упражнений. Спросите у меня что-нибудь про отжимания, приседания или пресс, например, как правильно делать отжимания.'
        return
